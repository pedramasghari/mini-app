...
export default function Header({ onDeposit, onWithdraw, onTransactions, onLogout }: HeaderProps) {
  ...
  return (
    <header dir="rtl" className="sticky top-0 z-30 -mx-3 mb-4 flex min-w-0 items-center justify-between gap-2 border-b border-white/5 bg-[#070b14]/90 px-3 py-3 backdrop-blur-xl sm:-mx-5 sm:px-5">
      <div className="min-w-0">
        <p className="truncate text-[10px] font-bold text-cyan-300/70">فروشگاه</p>
